...
import { Globe, Flag, ArrowRight, MapPin } from "lucide-react";

const QuocGiaPage = () => {
  // Màu sắc DaisyUI cho các thẻ quốc gia
    ...
    <div className="min-h-screen pt-20 bg-base-100">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-base-content">Quốc gia</h1>
            <p className="text-base-content/70">
              Khám phá phim từ các quốc gia trên thế giới
            </p>
          </div>
        </div>
        ...
        <div className="stats shadow mb-8">
          <div className="stat">
            ...
            <div className="stat-title">Tổng số quốc gia</div>
            <div className="stat-value text-primary">{quocGia.length}</div>
            <div className="stat-desc">Phim từ khắp thế giới</div>
          </div>
        </div>
                ...
                >
                  <div className="card-body p-4">
                    ...
                    <div className="flex items-center justify-center mb-3">
                      ...
                      >
                        <Flag className={`w-6 h-6 ${colors.iconColor}`} />
                      </div>
                    </div>
