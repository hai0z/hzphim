            ...
            <SwiperSlide key={index} className={`${width < 768 && "pt-16"}`}>
              <motion.div className="w-full z-10" key={currentIndex}>
                ...
                <div className="absolute left-0 bottom-0 right-0 top-0 ">
                  <div className="w-full h-full bg-gradient-to-r from-[var(--color-base-100)] to-transparent"></div>
                </div>
              </motion.div>
              <div>
                <motion.div className="absolute bottom-10 md:top-0 flex flex-col md:justify-around lg:px-0 md:flex-row w-full px-8  xl:-mt-20 ">
                  <div
                    className={`${
                      currentIndex === index ? "opacity-100" : "opacity-0"
                    } w-full flex flex-col px-12 justify-end h-full`}
                  >
                    <motion.div
                      initial={{
                        x: 100,
                    ...
                    >
                      <motion.div>
                        <Link
                          ...
                          className="lg:text-[3rem] md:text-[2rem]  text-base-content font-bold py-1 text-center md:text-left hover:text-primary line-clamp-1"
                        >
                          {m.name}
                        </Link>
                      ...
                      >
                        <Link href={`/watch/${m.slug}`}>
                          <div
                            className={`btn btn-circle btn-primary w-16 h-16 shadow-primary/50 shadow-md hover:shadow-lg`}
                          >
                            <FaPlay size={24} />
                          </div>
                        </Link>
